...
hienthi.style.display = x.value == "doanhnghiep" ? "block" : "none";
}
...
var hienthi = document.getElementById("hienthi").value;
...
TongHoaDon1 =
  PhiXuLyHoaDon1 + PhiDichVuCoBan1 + ThueKenhCaoCap1 * sokenhcaocap;
console.log(
  "MaKhachHang : ",
  MaKhachHang,
...
var PhiDichVuCoBanhienthi = "";

var TongHoaDon = "";

if(x.value == "nhadan"){
  TongHoaDon1 = PhiXuLyHoaDon1 + PhiDichVuCoBan1 + ThueKenhCaoCap1 * sokenhcaocap;
  document.getElementById("ketqua").innerHTML = TongHoaDon1;

}else if(x.value == "doanhnghiep"){
  if (hienthi <= 10) {
    TongHoaDon = PhiXuLyHoaDon + PhiDichVuCoBan + ThueKenhCaoCap * sokenhcaocap;
    document.getElementById("ketqua").innerHTML = TongHoaDon;
  } else if (hienthi > 10) {
    PhiDichVuCoBanhienthi = 75 + (hienthi - 10) * 5;
    TongHoaDon =
      PhiXuLyHoaDon + PhiDichVuCoBanhienthi + ThueKenhCaoCap * sokenhcaocap;
      document.getElementById("ketqua").innerHTML = TongHoaDon;
  }
}
